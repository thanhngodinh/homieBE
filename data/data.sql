insert into users (id, username, phone, "password", email, is_verified_email, first_name , last_name, province_profile, district_profile, cost_from, cost_to, gender, is_find_roommate) values
('user00001', 'user1', '0123456789', '$2a$10$J4BEfdZT3rWL5lwcDOum6ugFvdTQ31zub0zJL2xMwvA3snH/KUCCy', 'user1@gmail.com', 1, 'A', 'Nguyen', 'Hà Nội', 'Ba Đình', 4000000, 5000000, 'W', true),
('user00002', 'user2', '0123456782', '$2a$10$J4BEfdZT3rWL5lwcDOum6ugFvdTQ31zub0zJL2xMwvA3snH/KUCCy', 'user2@gmail.com', 1, 'B', 'Nguyen', 'Hà Nội', 'Ba Đình', 2000000, 3000000, 'W', true),
('user00003', 'user3', '0123456783', '$2a$10$J4BEfdZT3rWL5lwcDOum6ugFvdTQ31zub0zJL2xMwvA3snH/KUCCy', 'user3@gmail.com', 1, 'C', 'Nguyen', 'Hà Nội', 'Hoàn Kiếm', 4000000, 6000000, 'M', true),
('user00004', 'user4', '0123456784', '$2a$10$J4BEfdZT3rWL5lwcDOum6ugFvdTQ31zub0zJL2xMwvA3snH/KUCCy', 'user4@gmail.com', 1, 'D', 'Nguyen', 'Hồ Chí Minh', 'Quận 1', 2000000, 5000000, 'M', true),
('user00005', 'user5', '0123456785', '$2a$10$J4BEfdZT3rWL5lwcDOum6ugFvdTQ31zub0zJL2xMwvA3snH/KUCCy', 'user5@gmail.com', 1, 'E', 'Nguyen', 'Hồ Chí Minh', 'Quận 12', 5000000, 4000000, 'M', true);
